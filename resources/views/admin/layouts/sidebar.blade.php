<aside id="sidebar"
    class="fixed inset-y-0 left-0 z-30 w-64 bg-blue-700 rounded-tr-[60px] p-4 flex flex-col justify-between transform -translate-x-full transition-transform duration-300 ease-in-out sm:translate-x-0 sm:static sm:flex-shrink-0">

    <nav class="mt-10 space-y-5">
        <a href="{{ route('admin.dashboard') }}"
            class="flex items-center gap-3 text-white rounded-lg px-4 py-3 font-semibold nav-link active">
        ...
        <a href="{{ route('admin.reports') }}"
            ...
            <svg class="w-3 h-4" viewBox="0 0 12 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a href="{{ route('admin.dashboard') }}"
            ...
            <svg class="w-4 h-4" viewBox="0 0 18 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 14.878L6 13.1624V1.12175L12 2.83738V14.878Z" fill="currentColor" />
            </svg>
            EcoTrack Map
        </a>
